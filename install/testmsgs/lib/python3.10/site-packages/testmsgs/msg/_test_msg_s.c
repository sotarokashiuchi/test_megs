...
bool testmsgs__msg__test_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("testmsgs.msg._test_msg.TestMsg", full_classname_dest, 30) == 0);
  }
  testmsgs__msg__TestMsg * ros_message = _ros_message;
  {  // x
...
PyObject * testmsgs__msg__test_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("testmsgs.msg._test_msg");
