...
static const _TestMsg_type_support_symbol_names_t _TestMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, testmsgs, msg, TestMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, testmsgs, msg, TestMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, testmsgs, msg, TestMsg)() {
  return &::testmsgs::msg::rosidl_typesupport_c::TestMsg_message_type_support_handle;
}
