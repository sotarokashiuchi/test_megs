...
#include "testmsgs/msg/detail/test_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "testmsgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _TestMsg__ros_msg_type = testmsgs__msg__TestMsg;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_testmsgs
size_t get_serialized_size_testmsgs__msg__TestMsg(
  const void * untyped_ros_message,
...
static uint32_t _TestMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_testmsgs__msg__TestMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_testmsgs
size_t max_serialized_size_testmsgs__msg__TestMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _TestMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_testmsgs__msg__TestMsg(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, testmsgs, msg, TestMsg)() {
