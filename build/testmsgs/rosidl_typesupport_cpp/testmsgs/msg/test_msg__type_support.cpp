...
static const _TestMsg_type_support_symbol_names_t _TestMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, testmsgs, msg, TestMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, testmsgs, msg, TestMsg)),
  }
};
...
{
  return &::testmsgs::msg::rosidl_typesupport_cpp::TestMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, testmsgs, msg, TestMsg)() {
  return get_message_type_support_handle<testmsgs::msg::TestMsg>();
}
